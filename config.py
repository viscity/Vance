...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/chalcogen645/vance.git",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/aboutva7ce")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/LOVE_COMMUNITY_l")
